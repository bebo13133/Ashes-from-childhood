                        ...
                        <div className='author-image-container'>
                            ...
                            <div className='author-quote-display'>
                                <div className='quote-container'>
                                    ...
                                    <p className='rotating-quote'>{authorQuotes[currentQuote]}</p>
                                    <cite className='quote-attribution'>- Сибел Ибрямова</cite>
                                </div>
                                <div className='quote-indicators'>
                                    {authorQuotes.map((_, index) => (
                                        <div key={index} className={`quote-dot ${index === currentQuote ? 'active' : ''}`}></div>
                                    ))}
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='author-bio'>
                                <div className='bio-section'>
                                    ...
                                    <p className='bio-text'>
                                        Сибел Ибрямова е съпруга и майка на две деца, които са вдъхновение за всичко, което твори. Любовта ѝ към думите се
                                        заражда още в тийнейджърските ѝ години, когато започва да пише стихове, поеми и приказки – един личен свят, в който тя
                                        превръща емоциите в истории. Днес аудиторията ѝ в социалните мрежи я познава като жена, която умее да разказва с обич и
                                        искреност – малки истории за семейството, детството и смисъла на истинската връзка между хората. Дебютната ѝ книга е
                                        отражение на собствения ѝ вътрешен свят – смела изповед, в която личните липси и преживявания се превръщат в литература.
                                    </p>
                                </div>
