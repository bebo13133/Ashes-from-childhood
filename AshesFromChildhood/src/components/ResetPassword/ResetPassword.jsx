                ...
                <div className='ResetPassword-reset-content'>
                    <div className='ResetPassword-reset-card'>
                        <div className='ResetPassword-success-header'>
                            ...
                            <p className='ResetPassword-success-subtitle'>Сега можете да влезете с новата си парола.</p>
                        </div>
                        ...
                        <div className='ResetPassword-success-actions'>
                            ...
                            <p className='ResetPassword-redirect-text'>Ще бъдете пренасочени автоматично след 3 секунди...</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='ResetPassword-reset-content'>
                <div className='ResetPassword-reset-card'>
                    <div className='ResetPassword-reset-header'>
                        ...
                        <p className='ResetPassword-reset-subtitle'>Моля, въведете новата си парола</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className='ResetPassword-reset-form'>
                        <div className='ResetPassword-form-group'>
                            ...
                            {validationErrors.password && <span className='ResetPassword-error-message'>{validationErrors.password}</span>}
                        </div>
                        ...
                        <div className='ResetPassword-form-group'>
                            ...
                            {validationErrors.confirmPassword && <span className='ResetPassword-error-message'>{validationErrors.confirmPassword}</span>}
                        </div>
                        ...
                        <button type='submit' className='ResetPassword-reset-btn' disabled={isLoading}>
                            {isLoading ? (
                                <>
