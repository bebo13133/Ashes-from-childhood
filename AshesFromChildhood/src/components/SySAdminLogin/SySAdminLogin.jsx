...
const SySAdminLogin = () => {
    ...
    const { onLoginSubmit, isAuthenticated, isLoading, errorMessage, clearError, onForgotPasswordSubmit } = useAuthContext();
    ...
    const handleForgotPassword = async (e) => {
        ...
        try {
            const result = await onForgotPasswordSubmit(forgotEmail);
            if (result.success) {
                    ...
                    {!showForgotPassword ? (
                        <form onSubmit={handleSubmit} className='admin-login-form'>
                            ...
                            <div className='auth-links'>
                                <button type='button' className='forgot-password-link' onClick={() => setShowForgotPassword(true)} disabled={isLoading}>
                                    Забравена парола?
                                </button>
